...
## *Author*: AAVA
## *Created on*: 
## *Description*: Snowflake Bronze Layer Logical Data Model for Yield Management Process (Updated)
## *Version*: 2
## *Updated on*: 
_____________________________________________

# Snowflake Bronze Model Logical for Yield Management Process (Updated)
